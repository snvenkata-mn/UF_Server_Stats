...
#ifndef API_WRAP_C
#undef OCILogoff
#define OCILogoff(svchp, errhp) \
      oci8_OCILogoff(svchp, errhp, __FILE__, __LINE__)
#endif
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCILogoff;
#define have_OCILogoff oci8_have_OCILogoff
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCILogoff (1)
#else
#define have_OCILogoff (0)
#endif
...
#define OCILogon2_nb(svcctx, envhp, errhp, svchp, username, uname_len, password, passwd_len, dbname, dbname_len, mode) \
      oci8_OCILogon2_nb(svcctx, envhp, errhp, svchp, username, uname_len, password, passwd_len, dbname, dbname_len, mode, __FILE__, __LINE__)
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCILogon2_nb;
#define have_OCILogon2_nb oci8_have_OCILogon2_nb
#elif ORACLE_CLIENT_VERSION >= ORAVER_9_0
#define have_OCILogon2_nb (1)
#else
#define have_OCILogon2_nb (0)
#endif
